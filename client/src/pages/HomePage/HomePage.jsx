  ...
  const contacts = [
    {
      ...
      desc: 'Discover your mental health status with interactive quizzes covering stress, anxiety, depression, and more. Get personalized recommendations, including therapist matches based on your results.',
      link: '/assessments'
    },
    {
      name: 'Therapy Sessions',
      desc: 'Access secure online therapy sessions with options for individual, group, or family therapy. Chat with your therapist and choose from a range of experienced professionals.',
    ...
    {
      name: 'Journal',
      desc: 'Reflect and track your thoughts, feelings, and experiences with a personal journaling feature. Write daily entries to promote self-awareness and emotional expression.',
      link: '/MyJournal'
    },
    {
    ...
    },
    {
      ...
      desc: 'Access a large library of articles, videos, and podcasts covering diverse mental health topics. Stay informed with updates on research, tips for well-being, understand mental health disorders.',
      link: '/library'
    }
  ];
  ...
  const team = [
    {
      ...
      imageUrl:
        'https://i.pinimg.com/564x/8b/08/ed/8b08ed0cb7a60f9372a160fcbacb47b1.jpg'
    },
    {
      name: 'Jane Smith',
      role: 'Designer',
      ...
      imageUrl:
        'https://i.pinimg.com/564x/cf/07/71/cf077191fe133661b8cb73e0292e50fe.jpg'
    },
    {
      name: 'Angela',
      role: 'Therapist',
