...
const TherapyPage = () => {
  ...
  const fetchBookedTherapists = async () => {
    try {
      const response = await fetch(`${backendUrl}/user-booked-therapists`, {
        credentials: 'include'
      });
      if (!response.ok) {
  ...
  const handleTherapistChange = async (e) => {
    ...
    try {
      const response = await fetch(
        `${backendUrl}/therapist-availability/${selectedId}`,
        {
          credentials: 'include'
        }
      );
  ...
  return (
    <div>
      ...
      <div className="booking-container">
        <div className="booking-form-container">
          ...
          <p>
            ...
            <Link to="/assessments">make the assessment</Link>. Its result will
            be sent to the therapist to help you more effectively!
          </p>
            ...
            <div className="form-group">
              ...
              >
                ...
                {availableTimes.map((time, index) => (
                  <option
                    key={index}
                    value={`${time.availability_date} ${time.start_time}-${time.end_time}`}
                  >
        ...
        {therapists.map((therapist) => (
          ...
          >
            ...
            <div className="therapist-info">
              ...
              <p>
                Specialization: <strong>{therapist.specialization}</strong>
              </p>
              <p>
                Location: <strong>{therapist.location}</strong>
              </p>
              <p>
                Online Therapy:{' '}
                <strong>
                  {therapist.virtual_available ? 'Available' : 'Not Available'}
                </strong>
      ...
      <div className="therapy-details">
        ...
        <p>
          Therapy encompasses a variety of approaches tailored to address
          different psychological and emotional needs individuals may face
          throughout their lives. Some common types include:
        </p>
        <ul>
          <li>
            <strong>Cognitive-Behavioral Therapy (CBT):</strong> Helps
            individuals identify and change negative thought patterns and
            behaviors.
          </li>
          <li>
            <strong>Psychodynamic Therapy:</strong> Explores unconscious
            thoughts and emotions to understand current behaviors and
            relationships.
          </li>
          <li>
            <strong>Family Therapy:</strong> Addresses conflicts and improves
            communication within families.
          </li>
          <li>
            <strong>Art Therapy:</strong> Uses creative expression to explore
            emotions and promote healing.
          </li>
          <li>
            <strong>Group Therapy:</strong> Provides support and feedback from
            peers dealing with similar issues.
          </li>
        </ul>
        <hr />
        ...
        <ul>
          <li>
            <strong>Managing Stress:</strong> Helps individuals cope with
            stressors in their personal or professional lives.
          </li>
          <li>
            <strong>Grief and Trauma:</strong> Assists in processing loss or
            traumatic experiences, facilitating healing.
          </li>
          <li>
            <strong>Life Transitions:</strong> Supports individuals adjusting to
            major life changes such as career shifts, marriage, or retirement.
          </li>
          <li>
            <strong>Mental Health Disorders:</strong> Provides strategies to
            manage symptoms of depression, anxiety, OCD, and other disorders.
          </li>
          <li>
            <strong>Improving Relationships:</strong> Enhances communication
            skills and fosters healthier interpersonal connections.
          </li>
        </ul>
        <hr />
        ...
        <ul>
          ...
          <li>
            Provides a safe space for emotional expression and validation.
          </li>
      ...
      {showModal && modalTherapist && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              <strong>Specialization:</strong> {modalTherapist.specialization}
            </p>
            <p>
              <strong>Location:</strong> {modalTherapist.location}
            </p>
            <p>
              <strong>Online Therapy:</strong>{' '}
              {modalTherapist.virtual_available ? 'Available' : 'Not Available'}
            </p>
            <p>
              <strong>In-person Therapy:</strong>{' '}
              {modalTherapist.in_person_available
                ? 'Available'
                : 'Not Available'}
            </p>
            <p>
              <strong>About:</strong> {modalTherapist.about}
            </p>
          </div>
        </div>
      )}
