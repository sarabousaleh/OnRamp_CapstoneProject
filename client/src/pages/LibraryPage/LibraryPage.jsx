...
const LibraryPage = () => {
    const recommendedReadings = [
        ...
        { title: 'Maybe You Should Talk to Someone', author: 'Lori Gottlieb', imageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1547189796i/37570546.jpg' },
        { title: 'Stop Overthinking', author: 'Nick Trenton', imageUrl: 'https://m.media-amazon.com/images/I/71k9zlFpoDL._AC_UF1000,1000_QL80_.jpg' },
        { title: 'Why Has Nobody Told Me This Before?', author: 'Dr. Julie Smith', imageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1670001084i/58536046.jpg' },
        { title: 'Emotional First Aid', author: 'Guy Winch', imageUrl: 'https://m.media-amazon.com/images/I/61h-3nb9YvL._AC_UF1000,1000_QL80_.jpg' },
        { title: 'An Unquiet Mind', author: 'Kay Redfield Jamison', imageUrl: 'https://m.media-amazon.com/images/I/51W9qy4X0NL._AC_UF1000,1000_QL80_.jpg' },
    ...
    const disorders = [
        {
            name: 'Depression',
            symptoms: 'Persistent sadness, loss of interest in activities, changes in appetite and sleep, fatigue, feelings of worthlessness, difficulty concentrating.',
            treatment: 'Therapy (e.g., cognitive-behavioral therapy), medication (antidepressants), lifestyle changes, and support groups.',
            video: 'https://www.youtube.com/embed/z-IR48Mb3W0?si=az14FB8IycfvlRlB'
        },
        {
            name: 'Anxiety Disorders',
            symptoms: 'Generalized Anxiety Disorder (GAD): Excessive worry about various aspects of life. Panic Disorder: Recurrent panic attacks with intense fear and physical symptoms. Social Anxiety Disorder: Fear of social situations and being judged by others.',
            treatment: 'Therapy (e.g., cognitive-behavioral therapy), medication (anti-anxiety medications, antidepressants), relaxation techniques, and lifestyle changes.',
            video: 'https://www.youtube.com/embed/vtUdHOx494E?si=XHAPOoJ2ZubfERX9'
        },
        
        {
            name: 'Bipolar Disorder',
            symptoms: 'Extreme mood swings with episodes of mania (elevated mood, increased energy, impulsive behavior) and depression (low mood, fatigue, hopelessness).',
            treatment: 'Medication (mood stabilizers, antipsychotics, antidepressants), therapy, lifestyle changes, and support groups.',
            video: 'https://www.youtube.com/embed/RrWBhVlD1H8?si=Xx0Hjty8T_ccQQOO'
        },
        {
            name: 'Schizophrenia',
            symptoms: 'Delusions, hallucinations, disorganized thinking, lack of motivation, social withdrawal, and cognitive difficulties.',
            treatment: 'Medication (antipsychotics), therapy (e.g., cognitive-behavioral therapy), social support, and rehabilitation programs.',
            video: 'https://www.youtube.com/embed/K2sc_ck5BZU?si=05JUlRj8-njYGy5k'
        },
        {
            name: 'Obsessive-Compulsive Disorder (OCD)',
            symptoms: 'Obsessions (intrusive, unwanted thoughts) and compulsions (repetitive behaviors or mental acts to reduce anxiety).',
            treatment: 'Therapy (e.g., cognitive-behavioral therapy with exposure and response prevention), medication (antidepressants), and support groups.',
            video: 'https://www.youtube.com/embed/-Zg6PEJHRoo?si=OMaKhCz77zGUUzP8'
        },
        {
            name: 'Post-Traumatic Stress Disorder (PTSD)',
            symptoms: 'Re-experiencing traumatic events through flashbacks or nightmares, avoidance of reminders, hyperarousal (e.g., being easily startled), negative changes in mood and thoughts.',
            treatment: 'Therapy (e.g., cognitive-behavioral therapy, EMDR), medication (antidepressants, anti-anxiety medications), and support groups.',
            video: 'https://www.youtube.com/embed/aAvZPaDlwR0?si=xZf76mpXcwtnE0Ke'
        },
        {
            name: 'Eating Disorders',
            symptoms: 'Anorexia Nervosa: Restriction of food intake leading to low body weight, intense fear of gaining weight, and distorted body image. Bulimia Nervosa: Binge eating followed by compensatory behaviors like vomiting or excessive exercise. Binge Eating Disorder: Recurrent episodes of eating large quantities of food without compensatory behaviors.',
            treatment: 'Therapy (e.g., cognitive-behavioral therapy), nutritional counseling, medication, and support groups.',
            video: 'https://www.youtube.com/embed/3Bax8ijH038?si=fXzXukVH_Og_F299'
        },
        {
            name: 'Attention-Deficit/Hyperactivity Disorder (ADHD)',
            symptoms: 'Inattention, hyperactivity, impulsivity that interferes with functioning or development.',
            treatment: 'Medication (stimulants, non-stimulants), therapy (behavioral therapy), lifestyle changes, and support for academic or occupational challenges.',
            video: 'https://www.youtube.com/embed/ymDJl6Yv5Ss?si=badG9XAdkTAr67Ga'
        },
        {
            name: 'Borderline Personality Disorder (BPD)',
            symptoms: 'Intense fear of abandonment, unstable relationships, impulsive behavior, self-harm, mood swings, chronic feelings of emptiness.',
            treatment: 'Therapy (e.g., dialectical behavior therapy), medication (mood stabilizers, antidepressants), and support groups.',
            ...
            <CollapsibleContainer title="Common Mental Health Disorders">
                ...
                {selectedDisorder && (
                    <div className="disorder-details">
                        ...
                        <p><strong>Symptoms:</strong> {selectedDisorder.symptoms}</p>
                        <p><strong>Treatment:</strong> {selectedDisorder.treatment}</p>
                        <div className="video-container">
                            <iframe width="560" height="315" src={selectedDisorder.video} title={`YouTube video about ${selectedDisorder.name}`} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                        </div>
                    </div>
                )}
