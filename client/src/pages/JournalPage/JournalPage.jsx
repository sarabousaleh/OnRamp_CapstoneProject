    ...
    return (
        <>
            ...
            <p className="p-journal">
                ...
                and with as little judgment as possible allows for self-discovery.
            </p>
            <p className="p-journal">
                Write your journal here every day! Write everything whether it was good or bad! Express what you are feeling and why you are feeling that way.
            </p>
                        ...
                        >
                            <div className="entry-header">
                                ...
                                <div className="entry-actions">
                                    <FontAwesomeIcon 
                                        icon={faEdit} 
                                        onClick={(e) => {e.stopPropagation(); handleEditEntry(entry.id, entry.content);}}
                                        style={{ cursor: 'pointer', marginRight: '10px', color: '#a14646' }}
                                    />
                                    <FontAwesomeIcon 
                                        icon={faTrashAlt} 
                            ...
                            {editingEntry === entry.id ? (
                                <div className="edit-entry">
                                    ...
                                    ></textarea>
                                    <button onClick={handleSaveEditedEntry} className="save-button">Save</button>
                                </div>
                            ) : (
                                <p className={`entry-content ${expandedEntry === entry.id ? 'expanded' : ''}`}>
                                    {entry.content.split('\n').slice(0, expandedEntry === entry.id ? undefined : 4).join('\n')}
                                </p>
                            )}
                        </div>
                    ))}
